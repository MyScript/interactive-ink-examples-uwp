...
if (-not[System.IO.File]::Exists("$PSScriptRoot\recognition-assets\conf\diagram.conf") -Or
...

	{
		...
		$url = "https://s3-us-west-2.amazonaws.com/iink/assets/1.5.0/myscript-iink-recognition-math.zip"
		...
		$clnt = new-object System.Net.WebClient
		$url = "https://s3-us-west-2.amazonaws.com/iink/assets/1.5.0/myscript-iink-recognition-diagram.zip"
		...
		$clnt = new-object System.Net.WebClient
		$url = "https://s3-us-west-2.amazonaws.com/iink/assets/1.5.0/myscript-iink-recognition-raw-content.zip"
		...
		$clnt = new-object System.Net.WebClient
		$url = "https://s3-us-west-2.amazonaws.com/iink/assets/1.5.0/myscript-iink-recognition-text-en_US.zip"
