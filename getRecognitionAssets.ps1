...
if (-not[System.IO.File]::Exists("$PSScriptRoot\recognition-assets\conf\diagram.conf") -Or
...

  {
    ...
    $url = "https://download.myscript.com/iink/recognitionAssets_iink_2.3/myscript-iink-recognition-math.zip"
    ...
    $clnt = new-object System.Net.WebClient
    $url = "https://download.myscript.com/iink/recognitionAssets_iink_2.3/myscript-iink-recognition-diagram.zip"
    ...
    $clnt = new-object System.Net.WebClient
    $url = "https://download.myscript.com/iink/recognitionAssets_iink_2.3/myscript-iink-recognition-raw-content.zip"
    ...
    $clnt = new-object System.Net.WebClient
    $url = "https://download.myscript.com/iink/recognitionAssets_iink_2.3/myscript-iink-recognition-text-en_US.zip"
