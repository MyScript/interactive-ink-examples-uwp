...
if (-not[System.IO.File]::Exists("$PSScriptRoot\recognition-assets\conf\diagram.conf") -Or
  ...
  -not[System.IO.File]::Exists("$PSScriptRoot\recognition-assets\conf\en_US.conf") -Or
  -not[System.IO.File]::Exists("$PSScriptRoot\recognition-assets\conf\mul_Latn.conf"))

  {
    ...
    $url = "https://download.myscript.com/iink/recognitionAssets_iink_4.4/myscript-iink-recognition-math.zip"
    ...
    $clnt = new-object System.Net.WebClient
    $url = "https://download.myscript.com/iink/recognitionAssets_iink_4.4/myscript-iink-recognition-math2.zip"
    ...
    $clnt = new-object System.Net.WebClient
    $url = "https://download.myscript.com/iink/recognitionAssets_iink_4.4/myscript-iink-recognition-diagram.zip"
    ...
    $clnt = new-object System.Net.WebClient
    $url = "https://download.myscript.com/iink/recognitionAssets_iink_4.4/myscript-iink-recognition-raw-content.zip"
    ...
    $clnt = new-object System.Net.WebClient
    $url = "https://download.myscript.com/iink/recognitionAssets_iink_4.4/myscript-iink-recognition-raw-content2.zip"
    ...
    $clnt = new-object System.Net.WebClient
    $url = "https://download.myscript.com/iink/recognitionAssets_iink_4.4/myscript-iink-recognition-text-en_US.zip"
    ...
    # Download myscript-iink-handwriting-recognition.zip

    $clnt = new-object System.Net.WebClient
    $url = "https://download.myscript.com/iink/recognitionAssets_iink_4.4/myscript-iink-handwriting-recognition.zip"
    $file = "$PSScriptRoot\myscript-iink-handwriting-recognition.zip"
    $clnt.DownloadFile($url,$file)

    # Unzip myscript-iink-handwriting-recognition.zip
    $zip_file = $shell_app.namespace($file)
    $destination.Copyhere($zip_file.items(),16)
    Remove-Item $file
  }
